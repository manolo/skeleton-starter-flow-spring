...
const minify = true;
const hash = true;
const shellFile = "./vaadin-flow-bundle.html";
const fragmentFiles = ['./view-1.html', './grid-fragment.html', './view-2.html'];
const es6SourceDirectory = "./frontend";
const targetDirectory = "../src/main/webapp";
            ...
            .then(() => {
                ...
                if (hash) {
                    processedStream = processedStream
                      .pipe(RevAll.revision()).pipe(gulp.dest('cdn'))
                      .pipe(RevAll.manifestFile()).pipe(gulp.dest('cdn'));
                }
